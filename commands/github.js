...
async function githubCommand(sock, chatId, message) {
  try {
    const res = await fetch('https://api.github.com/repos/DarkSadistic/DarkSadistic-MD');
    if (!res.ok) throw new Error('GitHub API fetch failed');
    const json = await res.json();

    const caption = `
┏━━━━━━━━━━━━━━━━━━━━━━━━━━┓
┃ 🧑‍💻 DarkSadistic-MD-GITHUB INFO🧑‍💻
┗━━━━━━━━━━━━━━━━━━━━━━━━━━┛
...
🧠 *Powered by Mr. Erøxe [RanaTahirG]*
...
`;
    ...
    if (imgBuffer) {
      await sock.sendMessage(chatId, {
        ...
        contextInfo: {
          externalAdReply: {
            title: "DarkSadistic-MD GitHub Repo",
